...
{% include media.html file="rocker-bogie-robot/image19.png" description="Sensors connection map" %}

## Detail Design
### Chassis

{% include media.html file="/rocker-bogie-robot/image6.png" description="Isometric view of Rocker Bogie Robot" %}
...
{% include media.html file="/rocker-bogie-robot/image26.png" description="Side view of Rocker Bogie Robot" %}

{% include media.html file="/rocker-bogie-robot/image23.png" description="Front view of Rocker Bogie Robot" %}

{% include media.html file="/rocker-bogie-robot/image14.jpg" description="Final assembly" %}

{% include media.html file="/rocker-bogie-robot/image24.jpg" description="Final assembly - side view" %}
...
{% include media.html file="/rocker-bogie-robot/image1.png" %}
{% include media.html file="/rocker-bogie-robot/image4.jpg" %}
{% include media.html file="/rocker-bogie-robot/image20.jpg" description="Sensor placement and assembly" %}
...
{% include media.html file="/rocker-bogie-robot/image33.png" description="Basic obstacle avoidance logic" %}
...
{% include media.html file="/rocker-bogie-robot/image32.png" description="Lifesign search mode" %}
...
{% include media.html file="/rocker-bogie-robot/image27.png" description="SLAM using onboard LIDAR sensor" %}

{% include youtube.html id="dGK0_Ku4cWg" %}

### Operator's User Interface (OUI)

{% include media.html file="/rocker-bogie-robot/image21.png" %}
...
{% include media.html file="/rocker-bogie-robot/image31.png" description="Available commands for the robot" %}
