...
{% include media.html file="/f1-engine/f1-rocket-engine.png" description="Rocketdyne F-1 Rocket Engine - First Stage" %}
...
{% include media.html file="/f1-engine/SaturnF1EngineDiagram.png" description="Saturn F1 Engine Diagram" %}
{% include media.html file="/f1-engine/model_expl.png" description="Overall Simplified ANSYS Model" %}
{% include media.html file="/f1-engine/spacecraft_assembly4.png" description="200 Bolts Securing Middle and Lower Part of the Nozzle" %}
...
{% include media.html file="/f1-engine/governingequations.png" description="Differential Equations of Equilibrium" %}

{% include media.html file="/f1-engine/Straindisplacement.png" description="Strain-Displacement Relations" %}

{% include media.html file="/f1-engine/matrixmodel.png" description="Constitutive Matrix Model" %}

## Initial Calculation/Prediction
### Axial Reaction of Thrust

{% include media.html file="/f1-engine/axial.png" %}
...
{% include media.html file="/f1-engine/hoop stress.png" %}
...
{% include media.html file="/f1-engine/thermal strain.png" %}
...
{% include media.html file="/f1-engine/bolt preload.png" %}
...
{% include media.html file="/f1-engine/tetrahedron-mesh.PNG" description="Tetrahedron Meshes Setup" %}
{% include media.html file="/f1-engine/tetrahedron-mesh-stat.PNG" description="Meshes Statistics" %}
...
{% include media.html file="/f1-engine/hex-meshes.PNG" description="Hex Dominant Meshes Setup" %}
{% include media.html file="/f1-engine/hex-meshes-stat.PNG" description="Meshes Statistics" %}
...
{% include media.html file="/f1-engine/thermal-strain-apply.PNG" %}

### Applying Bolt Preload

Load bolt pretension was applied to the surface of the bolt thread as follows:

{% include media.html file="/f1-engine/bolt-pretension-load.PNG" %}

### Applying Boundary Conditions

Frictionless support was added to the top of middle nozzle.

{% include media.html file="/f1-engine/frictionless-support.PNG" %}
...
{% include media.html file="/f1-engine/pressure-load.PNG" %}
{% include media.html file="/f1-engine/pressure-load-time.PNG" description="Pressure Load Time Step" %}
...
{% include media.html file="/f1-engine/force-regen-upper.PNG" description="Simulated Regeneration Channel Load at Middle Nozzle" %}
{% include media.html file="/f1-engine/force-regen-lower.PNG" description="Simulated Regeneration Channel Load at Lower Nozzle" %}

### Contact Surfaces

{% include media.html file="/f1-engine/bolt-to-nut.PNG" description="Bolt to Nut" %}
{% include media.html file="/f1-engine/lower-mid-nozzle.PNG" description="Lower to Middle Nozzle" %}
{% include media.html file="/f1-engine/bolt-mid-nozzle.PNG" description="Middle Nozzle to Bolt" %}
{% include media.html file="/f1-engine/bolt-lower-nozzle.PNG" description="Lower Nozzle to Bolt" %}
{% include media.html file="/f1-engine/bolt-contact.PNG" description="Bolt Contact" %}

## Finite Element Analysis Result

### Force Convergence

{% include media.html file="/f1-engine/force-convergence.png" description="Force Convergence Result - Solution Converged After 11th Iterations" %}

### Total Deformation

{% include media.html file="/f1-engine/total-deformation.png" %}
{% include media.html file="/f1-engine/total-deformation-stat.PNG" %}
...
{% include media.html file="/f1-engine/total-deformation-zoom.gif" description="Deformation Around the Bolted Nozzle Flanged" %}

### Hoop Stress

{% include media.html file="/f1-engine/normal-stress-lower.png" %}
...
{% include media.html file="/f1-engine/bolt-stress.gif" %}
{% include media.html file="/f1-engine/eqv-stress-bolt.png" description="Equivalent Stress on Bolt" %}

### Gap between Middle and Lower Nozzles

{% include media.html file="/f1-engine/gap.png" description="Maximum and Minimum Gap Between Middle and Lower Nozzle" %}
